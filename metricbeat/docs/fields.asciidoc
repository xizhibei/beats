...
Information and statistics of pods managed by kubelet.
...
[float]
=== kubelet.container.cpu.usage.core.ns
...
[float]
=== kubelet.container.cpu.usage.nanocores
...
[float]
=== kubelet.container.logs.available.bytes
...
[float]
=== kubelet.container.logs.capacity.bytes
...
[float]
=== kubelet.container.logs.used.bytes
...
[float]
=== kubelet.container.logs.inodes.count
...
[float]
=== kubelet.container.logs.inodes.free
...
[float]
=== kubelet.container.logs.inodes.used
...
[float]
=== kubelet.container.memory.available.bytes
...
[float]
=== kubelet.container.memory.usage.bytes
...
[float]
=== kubelet.container.memory.rss.bytes
...
[float]
=== kubelet.container.memory.workingset.bytes
...
[float]
=== kubelet.container.memory.pagefaults
...
[float]
=== kubelet.container.memory.majorpagefaults
...
[float]
=== kubelet.container.rootfs.capacity.bytes
...
[float]
=== kubelet.container.rootfs.available.bytes
...
[float]
=== kubelet.container.rootfs.used.bytes
...
[float]
=== kubelet.container.rootfs.inodes.used
...
[float]
=== kubelet.node.cpu.usage.core.ns
...
[float]
=== kubelet.node.cpu.usage.nanocores
...
[float]
=== kubelet.node.memory.available.bytes
...
[float]
=== kubelet.node.memory.usage.bytes
...
[float]
=== kubelet.node.memory.workingset.bytes
...
[float]
=== kubelet.node.memory.pagefaults
...
[float]
=== kubelet.node.memory.majorpagefaults
...
[float]
=== kubelet.node.network.rx.errors
...
[float]
=== kubelet.node.network.tx.errors
...
[float]
=== kubelet.node.fs.capacity.bytes
...
[float]
=== kubelet.node.fs.available.bytes
...
[float]
=== kubelet.node.runtime.imagefs.capacity.bytes
...
[float]
=== kubelet.node.runtime.imagefs.available.bytes
...
[float]
=== kubelet.node.runtime.imagefs.used.bytes
...
kubelet system containers metrics



[float]
=== kubelet.system.container
...
[float]
=== kubelet.system.cpu.usage.core.ns
...
[float]
=== kubelet.system.cpu.usage.nanocores
...
[float]
=== kubelet.system.memory.usage.bytes
...
[float]
=== kubelet.system.memory.rss.bytes
...
[float]
=== kubelet.system.memory.workingset.bytes
...
[float]
=== kubelet.system.memory.pagefaults
...
[float]
=== kubelet.system.memory.majorpagefaults
...
[float]
=== kubelet.volume.fs.capacity.bytes
...
[float]
=== kubelet.volume.fs.available.bytes
...
[float]
=== kubelet.volume.fs.inodes.count
...
PM2 status metrics collected from PM2 instances.
...
[float]
=== pm2.status.unstable_restarts

type: integer

[float]
=== pm2.status.node_version

type: keyword

[float]
=== pm2.status.exec_mode
